...
WLAN_FIRMWARE_SYMLINKS_6750 := $(TARGET_OUT_VENDOR)/firmware/wlan/qca_cld/qca6750/
$(WLAN_FIRMWARE_SYMLINKS_6750): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating WLAN firmware symlinks: $@"
	@rm -rf $@/*
	@mkdir -p $@
